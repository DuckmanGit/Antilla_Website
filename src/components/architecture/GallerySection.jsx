        ...
        <div className="swiper-wrapper">
          <SwiperSlide className="swiper-slide">
            <div className="single-gallery-img">
              ...
              <img src="assets/img/home3/gallery1.jpg" alt="" />
            </div>
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <div className="single-gallery-img">
              ...
              <img src="assets/img/home3/gallery2.jpg" alt="" />
            </div>
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <div className="single-gallery-img">
          ...
          <SwiperSlide className="swiper-slide">
            <div className="single-gallery-img">
              ...
              <img src="assets/img/home3/gallery4.jpg" alt="" />
            </div>
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <div className="single-gallery-img">
              ...
              <img src="assets/img/home3/gallery5.jpg" alt="" />
            </div>
          </SwiperSlide>
        </div>
      </Swiper>
