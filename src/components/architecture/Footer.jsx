                ...
                <li>
                  <div className="single-contact">
                    ...
                    <div className="content">
                      ...
                      <h6><a href="tel:918292552841">8292552841</a></h6>
                    </div>
                  </div>
              ...
              <div className="row gy-xl-0 gy-5">
                <div className="col-lg-12 order-xl-1 order-2">
                  <div className="contact-banner-area">
                    <h4>Don’t miss to Subscribe Stay Connected With Us.</h4>
                    <form>
                        ...
                        <div className="footer-widget">
                          <ul className="address-area">
                            <li className="single-address">
                              <span>Mumbai</span>
                              <a href="https://g.co/kgs/NkuNsZr">1515 D, One Lodha Place, Senapati Bapat Marg, Lower Parel, Mumbai</a>
                            </li>
                            <li className="single-address">
                              <span>Mumbai</span>
