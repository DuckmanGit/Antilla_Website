                            ...
                            <ul className="contact-area">
                                ...
                                <li>
                                    <div className="single-contact">
                                        ...
                                        <div className="content">
                                            <span>ADDRESS</span>
                                            <h6><a href="https://g.co/kgs/NkuNsZr">Mumbai, Maharashtra</a></h6>
                                        </div>
                                    </div>
                                    <svg className="arrow" width={8} height={29} viewBox="0 0 8 29" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.33333 3C1.33333 4.47276 2.52724 5.66667 4 5.66667C5.47276 5.66667 6.66667 4.47276 6.66667 3C6.66667 1.52724 5.47276 0.333333 4 0.333333C2.52724 0.333333 1.33333 1.52724 1.33333 3ZM3.64645 28.3536C3.84171 28.5488 4.15829 28.5488 4.35355 28.3536L7.53553 25.1716C7.7308 24.9763 7.7308 24.6597 7.53553 24.4645C7.34027 24.2692 7.02369 24.2692 6.82843 24.4645L4 27.2929L1.17157 24.4645C0.976311 24.2692 0.659728 24.2692 0.464466 24.4645C0.269204 24.6597 0.269204 24.9763 0.464466 25.1716L3.64645 28.3536ZM3.5 3V28H4.5V3H3.5Z" />
                                ...
                                <li>
                                    <div className="single-contact">
                                        ...
                                        <div className="content">
                                            <span>SAY HELLO</span>
                                            <h6><a href="mailto:info@example.com">info@antilla.co</a></h6>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <div className="col-lg-12 order-xl-1 order-2">
                                    <ul className="address-area">
                                        <li className="single-address">
                                            <span>Mumbai</span>
                                            <a href="https://g.co/kgs/NkuNsZr">1515 D, One Lodha Place, Senapati Bapat marg, Lower Parel<br/>, Mumabi, Maharashtra, 400013</a>
                                        </li>
                                        <li className="single-address">
                                            <span>Mumbai</span>
                                            <a href="https://g.co/kgs/NkuNsZr">1217, One Lodha Place</a>
                                        </li>
                                        {/* <li className="single-address">
                                            ...
                                            <div className="col-xxl-7 col-md-8 col-sm-9">
                                                <div className="footer-widget">
                                                    ...
                                                    <div className="menu-container">
                                                        ...
                                                        <ul className="widget-list">
                                                            <li><Link href="/services">Public Works</Link></li>
                                                            <li><Link href="/services">Sustainable</Link></li>
                                                            <li><Link href="/services">Pre-Construction</Link></li>
                                                            <li><Link href="/services">Heavy Civil</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="footer-widget">
                                                    ...
                                                    <div className="menu-container">
                                                        <ul className="widget-list">
                                                            ...
                                                            <li><Link href="/about">Our Project</Link></li>
                                                            <li><Link href="/about">Blog &amp; Article</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
