...
import AboutSection from '@/components/redevelopment/AboutSection'
import Banner from '@/components/redevelopment/Banner'
import Banner2Section from '@/components/redevelopment/Banner2Section'
import BlogSection from '@/components/redevelopment/BlogSection'
import Footer from '@/components/redevelopment/Footer'
import ProcessSection from '@/components/redevelopment/ProcessSection'
import ProjectSection from '@/components/redevelopment/ProjectSection'
import ServiceSection from '@/components/redevelopment/ServiceSection'
import TestimonialSection from '@/components/redevelopment/TestimonialSection'
import WhyChooseSection from '@/components/redevelopment/WhyChooseSection'
