            ...
            <div className="col-lg-5">
              <div className="about-content">
                <ul>
                  <li>
                    <h5>Who we are</h5>
                    <p>Antilla Estates Private Limited is a premier asset holding and construction company with a robust portfolio(GDV) valued at over ₹1500 crores. Headquartered in Mumbai, we specialize in visionary real estate development, strategic asset management, and innovative redevelopment projects.&amp; start.</p>
                  </li>
                  <li>
                    <h5>Our Mission</h5>
